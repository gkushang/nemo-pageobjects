...
module.exports = function page(pagesDirectory, world) {
    var pages = [];
    var page = {};
    ...
    function instantiate(file) {
        ...
        page[pageName] = pages[0](world.nemo);
        world[pageName] = pages[0](world.nemo);
        return page;
    }
    ...
    return new Promise(function(resolve, reject) {
        function instantiatePages(err, pages) {
            if (err || pages.length <= 0) {
                ...
                world.nemo.page = map(pages, instantiate);
                resolve(world.nemo.page);
            }
        }
